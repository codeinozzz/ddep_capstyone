...
def main():
    parser = argparse.ArgumentParser(
        description="AI Cladding & Facade Designer - Complete Generator"
    )
    ...
    parser.add_argument(
        "--output-dir", type=str, default="outputs", help="Base directory for outputs"
    )
    ...
    specification = design_gen.generate_specification(
        style=args.style, space=args.space, size=args.size, colors=colors_list
    )
